...
const QueryingTheKeyMessage = (props: Props): InteractionReplyOptions => ({
    content: `||${props.interaction.user}||`,
    embeds: [
        new Discord.EmbedBuilder()
            .setColor(colors.invisible!)
            .setDescription(`> ${emojis.loading} Buscando informações sobre a key...`)
            .setFooter({ text: `Isto pode demorar um pouco até que o servidor responda!` })
    ],
    ephemeral: true
})

export { QueryingTheKeyMessage }